...
package com.cozary.golden_eye.entities;
...
public class GoldenEyeEntity extends Entity implements ItemSupplier {
    private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.defineId(GoldenEyeEntity.class, EntityDataSerializers.ITEM_STACK);
    private double tx;
    private double ty;
    private double tz;
    private int life;
    ...
    public GoldenEyeEntity(EntityType<? extends GoldenEyeEntity> p_36957_, Level p_36958_) {
        super(p_36957_, p_36958_);
    }

    public GoldenEyeEntity(Level p_36960_, double p_36961_, double p_36962_, double p_36963_) {
        this(ModEntityTypes.GOLDEN_EYE.get(), p_36960_);
    ...
    public @NotNull ItemStack getItem() {
        ...
        return itemstack.isEmpty() ? new ItemStack(ModItems.GOLDEN_EYE.get()) : itemstack;
    }

    public void setItem(ItemStack p_36973_) {
        if (!p_36973_.is(ModItems.GOLDEN_EYE.get()) || p_36973_.hasTag()) {
    ...
    public void addAdditionalSaveData(@NotNull CompoundTag p_36975_) {
        ItemStack itemstack = this.getItemRaw();
